...
func TestNewLevel(t *testing.T) {
	...
	blocks := []struct {
		...
		{0, 0, 0, Block{ID: 12, Data: 13}},
		{0, 250, 0, Block{ID: 2, Data: 1}},
		{185, 0, 10115, Block{ID: 45, Data: 14}},
		{4564, 250, 4645, Block{ID: 67, Data: 4}},
		{4232, 25, -4234234, Block{ID: 143, Data: 7}},
		{-2427824, 35, 23214, Block{ID: 431, Data: 6}},
		{-23478621, 0, -12341234, Block{ID: 32, Data: 8}},
		{4438, 120, -3123, Block{ID: 98, Data: 13}},
		{9762, 45, 3873, Block{ID: 179, Data: 5}},
		{39234, 101, 37482, Block{ID: 258, Data: 11}},
	}
	...
	for n, block := range blocks {
		if err := l.SetBlock(block.x, block.y, block.z, block.Block); err != nil {
			...
			t.Error(err.Error())
		} else if !block.EqualBlock(tBlock) {
...
func TestSkyLight(t *testing.T) {
	...
	tests := []struct {
		...
		{[]posBlock{
			{100, 10, 100, Block{ID: 8}},
		}, [][4]int32{
			{100, 10, 100, 12},
		}},
		{[]posBlock{
			{99, 12, 100, Block{ID: 1}},
			{99, 11, 100, Block{ID: 1}},
			{99, 10, 100, Block{ID: 1}},
			{99, 9, 100, Block{ID: 1}},
			{99, 8, 100, Block{ID: 1}},
			{99, 7, 100, Block{ID: 1}},

			{101, 12, 100, Block{ID: 1}},
			{101, 11, 100, Block{ID: 1}},
			{101, 10, 100, Block{ID: 1}},
			{101, 9, 100, Block{ID: 1}},
			{101, 8, 100, Block{ID: 1}},
			{101, 7, 100, Block{ID: 1}},

			{100, 12, 99, Block{ID: 1}},
			{100, 11, 99, Block{ID: 1}},
			{100, 10, 99, Block{ID: 1}},
			{100, 9, 99, Block{ID: 1}},
			{100, 8, 99, Block{ID: 1}},
			{100, 7, 99, Block{ID: 1}},

			{100, 12, 101, Block{ID: 1}},
			{100, 11, 101, Block{ID: 1}},
			{100, 10, 101, Block{ID: 1}},
			{100, 9, 101, Block{ID: 1}},
			{100, 8, 101, Block{ID: 1}},
			{100, 7, 101, Block{ID: 1}},

			{100, 8, 100, Block{ID: 8}},
			{100, 7, 100, Block{ID: 1}},

			{100, 11, 100, Block{ID: 8}},
			{100, 9, 100, Block{ID: 8}},
		}, [][4]int32{
			{100, 8, 100, 3},
			{100, 9, 100, 6},
			{100, 10, 100, 9},
		...
		{[]posBlock{
			{100, 12, 100, Block{ID: 8}},
			{100, 7, 100, Block{ID: 8}},
			{100, 6, 100, Block{ID: 1}},
		}, [][4]int32{
			{100, 6, 100, 0},
			{100, 7, 100, 0},
			{100, 8, 100, 0},
